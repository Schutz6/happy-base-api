...
class MongoModel(object):
    ...
    def insert_one(self, data):
        res = MongoBaseHandle.insert_one(self.collection, data)
        return res

    def insert_many(self, data_list):
        res = MongoBaseHandle.insert_many(self.collection, data_list)
        return res

    def update_one(self, data, data_set):
        res = MongoBaseHandle.update_one(self.collection, data, data_set)
        return res

    def update_many(self, data, data_set):
        res = MongoBaseHandle.update_many(self.collection, data, data_set)
        return res

    def find_one(self, data, data_field={}):
        res = MongoBaseHandle.find_one(self.collection, data, data_field)
        return res

    def find_many(self, data, data_field={}):
        """ 有多个键值的话就是 AND 的关系"""
        res = MongoBaseHandle.find_many(self.collection, data, data_field)
        return res
    ...
    def find_page(self, page_size, current_page, sort_data, data, data_field={}):
        res = MongoBaseHandle.find_page(self.collection, page_size, current_page, sort_data, data, data_field)
        return res
    ...
    def delete_one(self, data):
        """ 删除单行数据 如果有多个 则删除第一个"""
        res = MongoBaseHandle.delete_one(self.collection, data)
        return res

    def delete_many(self, data):
        """ 删除查到的多个数据 data 是一个字典 """
        res = MongoBaseHandle.delete_many(self.collection, data)
        return res

    def aggregate(self, data):
        res = MongoBaseHandle.aggregate(self.collection, data)
        return res
...
class MongoBaseHandle(object):
    ...
    @staticmethod
    def find_page(collection, page_size, current_page, sort_data, data, data_field={}):
        if len(data_field):
